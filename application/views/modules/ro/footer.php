...
<section class="footer-menu d-md-none d-block">
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="d-flex align-items-center justify-content-between">
				<div class="text-center">
					<a href="#" class="footer-button">
						<svg xmlns="http://www.w3.org/2000/svg" class="me-1" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
...
<a href="#" id="back-to-top" class="d-none d-md-block">&#8593;</a>
...
<script src="<?= base_url('assets/js/config.js?v=129') ?>"></script>
<script src="<?= base_url('assets/js/aos.js') ?>"></script>
<script src="<?= base_url('assets/js/smooth-navigate.js') ?>"></script>
<script src="<?= base_url('assets/js/back-to-top.js') ?>"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.13.14/dist/js/bootstrap-select.min.js"></script>
<script type="text/javascript">
    $('.lang-select').selectpicker();

    <?php  if($this->session->userdata('PREFLANG')) {?>
    	$('.selectpicker').selectpicker('val', '<?= $this->session->userdata('PREFLANG') ?>');
	<?php }?>
</script>
<script type="text/javascript"> (function() { function async_load(){ var s = document.createElement('script'); s.type = 'text/javascript'; s.async = true; var theUrl = 'https://gcr.org/reviews/1GppWrwh/js_widget.js'; s.src = theUrl + ( theUrl.indexOf("?") >= 0 ? "&" : "?") + 'ref=' + encodeURIComponent(window.location.href); var embedder = document.getElementById('score-widget-script'); embedder.parentNode.insertBefore(s, embedder); } if (window.attachEvent) window.attachEvent('onload', async_load); else window.addEventListener('load', async_load, false); })(); </script>
...
<script>
    ...
    langpick.addEventListener('change', ()=> {
	    window.location.href = "<?= base_url('sl/') ?>" + langpick.value;
	})
