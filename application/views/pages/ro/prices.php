		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<h1 class="hob-service-title">Tarife servicii</h1>
				</div>
				<div class="col-md-12 mt-5 mt-md-5 ">
							...
							<div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
								<div class="accordion-body">
									<table class="table" style="border-collapse: collapse; width: 100%; height: 242px;" border="1">
										...
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">Consultație de specialitate estetică dentară + radiografii</td>
											<td style="width: 50%; height: 19px;">300&nbsp; &nbsp;RON</td>
										</tr>
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">Fațeta dentara EMAX</td>
											<td style="width: 50%; height: 19px;">1950 RON</td>
										</tr>
										<tr>
											<td style="width: 50%;">Fațeta dentara din COMPOZIT / DINTE</td>
											<td style="width: 50%;">950&nbsp; &nbsp;RON</td>
										</tr>
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">Coroana dentara EMAX</td>
											<td style="width: 50%; height: 19px;">1950 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Coroana pe implant</td>
											<td style="width: 50%; height: 18px;">1950 RON</td>
										</tr>
										<tr>
											<td style="width: 50%;">Coroana zirconiu</td>
											<td style="width: 50%;">1850 RON</td>
										</tr>
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">Mock-up/ arcadă</td>
											<td style="width: 50%; height: 19px;">1000 RON</td>
										</tr>
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">DSD - Digital Smile Design</td>
											<td style="width: 50%; height: 19px;">1800 RON</td>
										</tr>
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;"><strong><span style="color: #c63131;">* </span></strong>Pachet ALBIRE ZOOM PHILIPS+DETARTRAJ și PERIAJ</td>
											<td style="width: 50%; height: 19px;"><span style="text-decoration: line-through;">1700 RON</span><span style="color: #c63131;">&nbsp; 990 RON</span></td>
										</tr>
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">Albire ZOOM Philips</td>
											<td style="width: 50%; height: 19px;">1550 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Detartraj + Periaj + Airflow</td>
											<td style="width: 50%; height: 18px;">350&nbsp; &nbsp;RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Detartraj + Periaj&nbsp;</td>
											<td style="width: 50%; height: 18px;">250&nbsp; &nbsp;RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Airflow / ARCADA</td>
							...
							<div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
								<div class="accordion-body">
									<table class="table" style="border-collapse: collapse; width: 98.2438%; height: 272px;" border="1">
										...
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">Ablație dentatus/ DCR</td>
											<td style="width: 50%; height: 19px;">150 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Aplicare MTA la MICROSCOP</td>
											<td style="width: 50%; height: 18px;">400 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Armare pivot fibră</td>
											<td style="width: 50%; height: 18px;">300 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Desensibilizant</td>
											<td style="width: 50%; height: 18px;">100 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Dezobturare mono la MICROSCOP</td>
											<td style="width: 50%; height: 18px;">200 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Dezobturare pluri la MICROSCOP</td>
											<td style="width: 50%; height: 18px;">300 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Drenaj endodontic</td>
											<td style="width: 50%; height: 18px;">150 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Extirpare nerv dinte</td>
											<td style="width: 50%; height: 18px;">150 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Extirpare și obturație mono la MICROSCOP</td>
											<td style="width: 50%; height: 18px;">600 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Extirpare și obturație premolar la MICROSCOP</td>
											<td style="width: 50%; height: 18px;">850 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Extirpare și obturație pluri la MICROSCOP</td>
											<td style="width: 50%; height: 18px;">950 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Îndepărtare corp străin la MICROSCOP</td>
											<td style="width: 50%; height: 18px;">350 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Pansament antiseptic</td>
											<td style="width: 50%; height: 18px;">150 RON</td>
										</tr>
										<tr style="height: 18px;">
											<td style="width: 50%; height: 18px;">Pansament calmant</td>
											<td style="width: 50%; height: 18px;">150 RON</td>
										</tr>
										</tbody>
									</table>
							...
							<div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
								<div class="accordion-body">
									<table class="table" style="border-collapse: collapse; width: 100%;" border="1">
										...
										<tr>
											<td style="width: 50%;">Obturație anterioară</td>
											<td style="width: 50%;">450 RON</td>
										</tr>
										<tr>
											<td style="width: 50%;">Obturație posterioară</td>
											<td style="width: 50%;">350 RON</td>
										</tr>
										<tr>
											<td style="width: 50%;">Coafaj direct</td>
											<td style="width: 50%;">150 RON</td>
										</tr>
										<tr>
											<td style="width: 50%;">Coafaj indirect</td>
											<td style="width: 50%;">150 RON</td>
										</tr>
										</tbody>
									</table>
								...
								<div class="accordion-body">
									<table class="table" style="border-collapse: collapse; width: 100%; height: 362px;" border="1">
										...
										<tr style="height: 19px;">
											...
											<td style="width: 50%; height: 19px;">Prețul diferă în funcție de caz</td>
										</tr>
										<tr style="height: 19px;">
							...
							<div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
								<div class="accordion-body">
									<table class="table" style="border-collapse: collapse; width: 100%; height: 133px;" border="1">
										...
										<tr style="height: 19px;">
											<td style="width: 50%; height: 19px;">Chiuretaj în câmp închis/ arcadă</td>
